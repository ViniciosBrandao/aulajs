...
function calcularContaSaneago(consumidorTipo, consumoM3){
    ...
    switch (tipoFormatado) {
        case residencial:   
            return 5 + (0.55 * consumoM3);

        case comercial: 
            return 150 + (1.25 * consumoM3);

        case industrial: 
            return 280 + (2.54 * consumoM3);
...
// Saída da Informação
if (valorFaturaAgua === null) {
    console.log("Tipo do consumidor inválido. Válido: a, b ou c.");
} else {
